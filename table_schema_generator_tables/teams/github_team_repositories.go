...
type TableGithubTeamRepositoriesGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableGithubTeamRepositoriesGenerator{}

func (x *TableGithubTeamRepositoriesGenerator) GetTableName() string {
	return "github_team_repositories"
}

func (x *TableGithubTeamRepositoriesGenerator) GetTableDescription() string {
	return ""
}

func (x *TableGithubTeamRepositoriesGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableGithubTeamRepositoriesGenerator) GetOptions() *schema.TableOptions {
...
func (x *TableGithubTeamRepositoriesGenerator) GetDataSource() *schema.DataSource {
...
func (x *TableGithubTeamRepositoriesGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return nil
}

func (x *TableGithubTeamRepositoriesGenerator) GetColumns() []*schema.Column {
...
func (x *TableGithubTeamRepositoriesGenerator) GetSubTables() []*schema.Table {
	return nil
}
